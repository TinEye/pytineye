...
class TestTinEyeAPIRequest(unittest.TestCase):
    ...
    def setUp(self):
        self.api = TinEyeAPIRequest(api_url='http://api.tineye.com/rest/', public_key='public_key', private_key='private_key')
    ...
    def test_tineye_response(self):
        ...
        r = TinEyeResponse.from_dict(matches)
